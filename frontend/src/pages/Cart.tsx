...
interface CartItem {
  ...
  unit: string;
  isOrganic?: boolean;
  deliveryDate?: string;   // ✅ Garland date
  slot?: "morning" | "evening"; // ✅ Garland slot
}
    ...
    return (
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="container px-4 py-32 text-center">
          ...
          <Button
            size="lg"
            className="bg-primary text-white shadow-lg shadow-primary/50 hover:bg-primary/90 transition duration-200"
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="space-y-4">
              {cartItems.map((item) => (
                <Card
                  key={item.id}
                  className="shadow-md hover:shadow-lg transition duration-300 border-l-4 border-primary/50 hover:border-primary"
                >
          ...
          <div className="lg:col-span-1">
            <Card className="sticky top-8 shadow-2xl border-primary/30 border-2">
              <CardContent className="p-6 space-y-4">
                ...
                <Button
                  size="lg"
                  className="w-full text-lg bg-primary hover:bg-primary/90 transition duration-300 shadow-lg shadow-primary/40 mt-6"
