...
// 🔐 Auth routes
router.post("/signup", upload_middleware_1.upload.fields([{ name: 'profile_image', maxCount: 1 }, { name: 'document', maxCount: 1 }]), delivery_controller_1.signupDeliveryPartner);
